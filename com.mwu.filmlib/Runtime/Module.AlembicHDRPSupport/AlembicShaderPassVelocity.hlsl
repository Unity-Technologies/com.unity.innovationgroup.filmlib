...
{
    float3 alembicVelocity    : TEXCOORD3; // Alembic computes velocities on runtime side.
                        ...
                        AttributesPass inputPass)
{
    ...
    else
    {
        ...
        float3 previousPositionRWS = TransformPreviousObjectToWorld(inputMesh.positionOS - inputPass.alembicVelocity);
#else
        float3 previousPositionRWS = TransformPreviousObjectToWorld(inputMesh.positionOS - inputPass.alembicVelocity);
#endif

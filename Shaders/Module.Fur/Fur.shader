Shader "HDRP/Film/Fur"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //#include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassDepthOnly.hlsl"
            #include "ShaderPass/FurShaderPassDepth.hlsl"
        ...
        {
            Name "FurShellOpaque"
            Tags { "LightMode" = "FurShellOpaque" } // This will be only for transparent object based on the RenderQueue index
            ...
            //#include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassForward.hlsl"
            #include "ShaderPass/FurShaderPassForward.hlsl"

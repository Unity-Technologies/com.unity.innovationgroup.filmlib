    ...
    public class EditorIcons
    {
        ...
        protected static void LoadAssets()
        {
            ...
            icons = new Dictionary<string, Texture2D>()
            {
                ...
                {  "Play", LoadAsset("White/Icons/play_arrow.png") },
                {  "Stop", LoadAsset("White/Icons/stop.png") },
                {  "SkipNext", LoadAsset("White/Icons/skip_next.png") },
                {  "SkipPrevious", LoadAsset("White/Icons/skip_previous.png") },
                {  "FastForward", LoadAsset("White/Icons/fast_forward.png") },
                {  "FastRewind", LoadAsset("White/Icons/fast_rewind.png") },

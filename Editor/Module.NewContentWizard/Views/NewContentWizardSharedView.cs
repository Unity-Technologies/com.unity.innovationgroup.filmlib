    ...
    public class NewContentWizardSharedView : EditorWindow
    {
        ...
        protected void DrawBanner(CONTENTWINDOW windowType)
        {
                ...
                case CONTENTWINDOW.NEWCONTENTWIZARD:
                    {
                        ...
                        if (bannerLogoNewContent == null)
                        {
                            ...
                            bannerLogoNewContent = LoadAsset("White/Banner/NewContentWizard.png");
                        }
                        break;
                    }
                case CONTENTWINDOW.TEMPLATEEDITOR:
                    {
                        if( bannerLogoTemplateEditor == null)
                        {
                            ...
                            bannerLogoTemplateEditor = LoadAsset( "White/Banner/TemplateEditor.png");
                        }
                        break;
                    }
            }
            ...
            if(headerBG == null)
            {
                ...
                var background = LoadAsset("White/Banner/Background.png");
        ...
        {
            if (imgArrowLeft == null) {  imgArrowLeft = LoadAsset("White/Icons/baseline_arrow_left_white_48dp.png"); assetLoadComplete = (imgArrowLeft != null) ? true : false;}
            if (imgArrowRight == null) { imgArrowRight = LoadAsset("White/Icons/baseline_arrow_right_white_48dp.png"); assetLoadComplete = (imgArrowRight != null) ? true : false; }
            if (imgArrowUp == null) { imgArrowUp = LoadAsset("White/Icons/baseline_arrow_drop_up_white_48dp.png"); assetLoadComplete = (imgArrowUp != null) ? true : false; }
            if (imgArrowDown == null) { imgArrowDown = LoadAsset("White/Icons/baseline_arrow_drop_down_white_48dp.png"); assetLoadComplete = (imgArrowDown != null) ? true : false; }
            if (imgAdd == null) { imgAdd = LoadAsset("White/Icons/baseline_add_white_48dp.png"); assetLoadComplete = (imgAdd != null) ? true : false; }
            if (imgRemove == null) { imgRemove = LoadAsset("White/Icons/baseline_remove_white_48dp.png"); assetLoadComplete = (imgRemove != null) ? true : false; }
            if (imgRefresh == null) { imgRefresh = LoadAsset("White/Icons/baseline_refresh_white_48dp.png"); assetLoadComplete = (imgRefresh != null) ? true : false; }
            if (imgClear == null) { imgClear = LoadAsset("White/Icons/baseline_clear_white_48dp.png"); assetLoadComplete = (imgClear != null) ? true : false; }
            if (imgEdit == null) { imgEdit = LoadAsset("White/Icons/baseline_edit_white_48dp.png"); assetLoadComplete = (imgEdit != null) ? true : false; }
            if (imgDone == null) { imgDone = LoadAsset("White/Icons/baseline_done_white_48dp.png"); assetLoadComplete = (imgDone != null) ? true : false; }
            if (imgCreate == null) { imgCreate = LoadAsset("White/Icons/baseline_create_white_48dp.png"); assetLoadComplete = (imgCreate != null) ? true : false; }
            if (imgSettings == null) { imgSettings = LoadAsset("White/Icons/baseline_settings_white_48dp.png"); assetLoadComplete = (imgSettings != null) ? true : false; }
            if (imgSave == null) { imgSave = LoadAsset("White/Icons/baseline_save_alt_white_48dp.png"); assetLoadComplete = (imgSave != null) ? true : false; }
            if (imgCancel == null) { imgCancel = LoadAsset("White/Icons/baseline_clear_white_48dp.png"); assetLoadComplete = (imgCancel != null) ? true : false; }
        ...
        {
            return AssetDatabase.LoadAssetAtPath<Texture2D>(Loc.CONTENTPATH + path);
        }
